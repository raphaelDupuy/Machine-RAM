...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_INSTRUCTION = 3,                /* INSTRUCTION  */
  YYSYMBOL_FDL = 4,                        /* FDL  */
  YYSYMBOL_VIRG = 5,                       /* VIRG  */
  YYSYMBOL_NUMB = 6,                       /* NUMB  */
  YYSYMBOL_YYACCEPT = 7,                   /* $accept  */
  YYSYMBOL_contenu = 8,                    /* contenu  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "INSTRUCTION", "FDL",
  "VIRG", "NUMB", "$accept", "contenu", "input", "programme", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* contenu: input FDL programme  */
#line 101 "regexp.y"
                                    { ; }
#line 1141 "regexp.tab.c"
    break;

  case 3: /* input: INSTRUCTION  */
#line 104 "regexp.y"
                                    { appendString(&debut, conc(3, "input = [", (yyvsp[0].lettre), "]\n\nprogramme = [\n")); }
#line 1147 "regexp.tab.c"
    break;

  case 4: /* programme: INSTRUCTION  */
#line 107 "regexp.y"
                                    { appendString(&debut, conc(3, "'", (yyvsp[0].lettre), "',\n")); }
#line 1153 "regexp.tab.c"
    break;

  case 5: /* programme: programme FDL programme  */
#line 108 "regexp.y"
                                    { ; }
#line 1159 "regexp.tab.c"
    break;

  case 6: /* programme: FDL programme  */
#line 109 "regexp.y"
                                    { ; }
#line 1165 "regexp.tab.c"
    break;

  case 7: /* programme: $end  */
#line 110 "regexp.y"
                                    { ; }
#line 1171 "regexp.tab.c"
    break;


#line 1175 "regexp.tab.c"
